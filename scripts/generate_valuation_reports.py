...
BUCKETS = {
    ...
    "core_base": {"label": "宽基底仓", "color": "#2f6fbd"},
...
TARGETS = [
    ...
    Target("159201.SZ", "自由现金流ETF华夏", "theme_etf", "权益防御/质量现金流", "防御仓观察", "自由现金流防御观察", "3%-6%"),
    ...
    Target("562500.SH", "机器人ETF华夏", "theme_etf", "机器人主题", "进攻主线观察", "机器人ETF观察", "0%-2%"),
    ...
    Target("002352.SZ", "顺丰控股", "stock", "质量修复/物流龙头", "主线仓观察", "顺丰控股质量修复观察", "0%-2%"),
    ...
    Target("515880.SH", "通信ETF国泰", "theme_etf", "通信主题", "进攻主线观察", "通信ETF观察", "0%-1%"),
]
