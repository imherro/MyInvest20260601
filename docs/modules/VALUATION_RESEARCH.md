...
| 分段 | 含义 | 默认动作边界 |
| --- | --- | --- |
| 低估观察区 | 价格/估值已进入赔率较好区域，但仍需趋势、资金和基本面确认 | 观察或 ACTION_PLAN 复核 |
| 合理配置区 | 估值与风险收益较均衡，是否配置取决于市场仓位和组合暴露 | 可作为配置候选 |
| 偏贵区 | 赔率下降，不宜因为趋势强就盲目新增 | 持有观察或控制新增 |
| 拥挤/风险区 | 估值或价格位置过高，容易出现回撤或拥挤踩踏 | 风险复核，不追高 |
